...
<asp:Content ID="Content1" ContentPlaceHolderID="body" runat="Server">
    ...
    <h1 id="pageHeader">Edit or Add a new Artist</h1>
    ...
    <div id="editFields">
        ...
        <br />
        <br />
        <asp:Button ID="btnAdd" Text="Add an artist" CssClass="buttons addButton" OnClick="btnAdd_Click" runat="server" />
        <br />
        ...
        <br />
        <asp:Label ID="lblMessages" Text="Select an artist to edit." runat="server" Font-Size="15"></asp:Label>
    </div>
</asp:Content>
