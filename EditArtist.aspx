...
<asp:Content ID="Content1" ContentPlaceHolderID="body" runat="Server">
    ...
    <asp:GridView ID="gvEditArtist" AutoGenerateSelectButton="true" OnSelectedIndexChanged="gvEditArtist_SelectedIndexChanged" CssClass="query" OnRowDataBound="gvEditArtist_RowDataBound" runat="server">
    </asp:GridView>
