...
<asp:Content ID="Content1" ContentPlaceHolderID="body" Runat="Server">
    <br /><h1 id="pageHeader" class="pageName">Genres</h1>
    <asp:Button ID="btnEdit" CssClass="buttons updateButton" PostBackUrl="~/EditPages/EditGenre.aspx" Text="Edit" runat="server" />
