...
<asp:Content ID="Content1" ContentPlaceHolderID="body" Runat="Server">
    ...
    <div id="editFields">
        ...
        <br />
        <br />
        <asp:Button ID="btnAdd" Text="Add company" CssClass="buttons addButton" OnClick="btnAdd_Click" runat="server" />
        <br />
        ...
        <br />
        <asp:Label ID="lblMessages" Text="Select company to edit." runat="server" Font-Size="15"></asp:Label>
    </div>
</asp:Content>
