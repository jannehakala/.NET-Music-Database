...
<asp:Content ID="Content1" ContentPlaceHolderID="body" Runat="Server">
    ...
    <div id="editFields">
        ...
        <br />
        <br />
        <asp:Button ID="btnAdd" Text="Add genre" CssClass="buttons addButton" OnClick="btnAdd_Click" runat="server" />
        <br />
        <asp:Button ID="btnSave" Text="Save changes" CssClass="buttons updateButton" OnClick="btnSave_Click" runat="server" />
        <br />
        <asp:Button ID="btnDelete" Text="Delete genre" CssClass="buttons deleteButton" OnClick="btnDelete_Click" OnClientClick="return confirm('Are you sure you want to delete this artist ?')" runat="server" /><br />
        <br />
        <asp:Label ID="lblMessages" Text="Select genre to edit." runat="server" Font-Size="15"></asp:Label>
    </div>
</asp:Content>
